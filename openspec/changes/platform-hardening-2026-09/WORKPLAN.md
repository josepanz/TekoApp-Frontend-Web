...
| I-01 | MEDIO   | [x]    | df0adc3, aeefea6, 45f5151, a6e88c7 | 4 specs (no implementación): `admin-audit-log-viewer.md`, `admin-bulk-actions.md`, `admin-data-export.md`, `admin-global-search.md`. Las 3 primeras dependen de un endpoint nuevo de backend — bloqueadas hasta esa coordinación                                    |
