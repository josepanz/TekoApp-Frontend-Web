...
| `openspec/specs/admin-global-search.md`    | Sin empezar. Ídem, contra `W-03` (filtro `search`). Sin endpoint agregador: la agregación es cliente, en paralelo contra `GET /users?search=` y `GET /professionals?search=`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| I-01 | MEDIO   | [~]    | df0adc3, aeefea6, 45f5151, a6e88c7, e4c84be, da4b2cf, c3259cf | 4 specs escritas + 3 implementadas. `admin-bulk-actions.md` **implementada** (piloto en `categories-table`, commit `e4c84be`) — ver detalle y pendiente de extender a otras tablas en §6. `admin-data-export.md` **implementada** (commit `da4b2cf`) — ver detalle en §6. `admin-audit-log-viewer.md` **implementada** (commit `c3259cf`) — ver detalle en §6. `admin-global-search.md` sigue sin empezar |
