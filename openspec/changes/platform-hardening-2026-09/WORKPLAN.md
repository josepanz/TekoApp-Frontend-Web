...
| G-06 | MEDIO   | [x]    | 5f55f17                                                                                           | Verificado: `notifications-table` y la cola de `professional-portfolio` NO tienen el problema (ya muestran nombres). Solo `ratings-table` lo tenía. Resolver nombres reales requiere DTO nuevo del backend (fuera de alcance) — se arregló el `#null` con "Anónimo"                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
