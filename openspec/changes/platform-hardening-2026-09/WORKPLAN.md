...
| I-01 | MEDIO   | [x]    | df0adc3, aeefea6, 45f5151, a6e88c7, e4c84be, da4b2cf, c3259cf, 076c1ac | 4 specs escritas y las 4 implementadas. `admin-bulk-actions.md` (piloto en `categories-table`, commit `e4c84be` — extender a otras tablas queda para después). `admin-data-export.md` (commit `da4b2cf`). `admin-audit-log-viewer.md` (commit `c3259cf`). `admin-global-search.md` (commit `076c1ac`, opción federada, con la corrección de `/users` sin `search` documentada ahí). Ver detalle de cada una en §6                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
