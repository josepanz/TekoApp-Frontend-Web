...
| `openspec/specs/admin-data-export.md`      | Sin empezar. Ídem, contra `W-02` (`GET /admin/payments/export`). Alcance 1ª iteración backend: CSV solamente, no armar selector de formato.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| I-01 | MEDIO   | [~]    | df0adc3, aeefea6, 45f5151, a6e88c7, e4c84be | 4 specs escritas + 1 implementada. `admin-bulk-actions.md` **implementada** (piloto en `categories-table`, commit `e4c84be`) — ver detalle y pendiente de extender a otras tablas en §6. `admin-audit-log-viewer.md`, `admin-data-export.md`, `admin-global-search.md` siguen sin empezar, bloqueadas por `W-01`/`W-02`/`W-03` de `TekoApp-Backend/openspec/changes/0015-admin-backoffice-endpoints.md` — verificar con `pnpm generate:api-types` antes de arrancar cada una |
