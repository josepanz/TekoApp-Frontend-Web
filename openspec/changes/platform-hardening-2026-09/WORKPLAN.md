...
| I-01 | MEDIO   | [x]    | df0adc3, aeefea6, 45f5151, a6e88c7 | 4 specs (no implementación): `admin-audit-log-viewer.md`, `admin-bulk-actions.md`, `admin-data-export.md`, `admin-global-search.md`. Implementación pendiente, con dependencias ya consolidadas en `TekoApp-Backend/openspec/changes/0015-admin-backoffice-endpoints.md` (`W-01`..`W-03`) — ver el mapeo spec↔`W-0N` en §6. `admin-bulk-actions.md` NO depende del backend: se puede implementar ya |
