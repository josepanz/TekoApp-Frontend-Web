...
| `openspec/specs/admin-audit-log-viewer.md` | Sin empezar. Requiere `pnpm generate:api-types` + `grep` del path para confirmar si `W-01` de `0015` (backend) ya mergeó antes de arrancar.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| I-01 | MEDIO   | [~]    | df0adc3, aeefea6, 45f5151, a6e88c7, e4c84be, da4b2cf | 4 specs escritas + 2 implementadas. `admin-bulk-actions.md` **implementada** (piloto en `categories-table`, commit `e4c84be`) — ver detalle y pendiente de extender a otras tablas en §6. `admin-data-export.md` **implementada** (commit `da4b2cf`) — ver detalle en §6. `admin-audit-log-viewer.md`, `admin-global-search.md` siguen sin empezar — `W-01`/`W-03` de `TekoApp-Backend/openspec/changes/0015-admin-backoffice-endpoints.md` ya mergeados (tipos regenerados en `750e0d4`), falta implementar del lado Web |
