...
> = {
  ...
  budget_options_ready: 'secondary',
  budget_option_selected: 'default',
  contract_created: 'secondary',
  contract_awaiting_signature: 'outline',
  contract_signed: 'default',
  payment_refunded: 'outline',
  document_approved: 'default',
  document_rejected: 'destructive',
  dispute_opened: 'destructive',
  dispute_resolved: 'default',
  account_deletion_requested: 'destructive',
  account_deletion_cancelled: 'secondary',
  professional_verified: 'default',
  professional_verification_rejected: 'destructive',
  professional_suspended: 'destructive',
